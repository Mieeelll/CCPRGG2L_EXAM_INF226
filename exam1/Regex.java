...
public class Regex {
    public static void main(String[] args) {
        ...
        // Provide the pattern
        pattern = Pattern.compile("^.*(?=.{6,})(?=.*[@#$%^&+=])(?=.*[^bcdfghjklmnpqrstvwxyz])(?=.*[^BCDFGHJKLMNPQRSTVWXYZ])(?=.*[0-9]).*$");
        ...
        pattern = Pattern.compile("(\\w{16})([_.])(\\d{2})+@gmail.com");
        ...
        // Provide regex pattern
        pattern = Pattern.compile("(http(s)?):\\/\\/www.+(\\w[Amiel])+([-.])(\\w[Metiam])+.com");
        ...
        // Provide the regex pattern
        tweet = tweet.replaceAll("\\b(http://apne.ws/AayqsiC)", "");
