public class Recursion {
    ...
    public static void main(String[] args) {
        ...
        String fullName = "amiel john pablo metiam";

        removeLetter(fullName);
    }

    static String removeLetter(String fullName) {
            // Add code here      
        if(fullName.isEmpty()){
        ...
        } if(fullName.charAt(0) == 'a' || fullName.charAt(0) == 'e' || fullName.charAt(0) == 'i' || fullName.charAt(0) == 'o' || fullName.charAt(0) == 'u') {

            removeLetter(fullName.substring(1));
        }
        else {
